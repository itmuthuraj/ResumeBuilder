...
<%@ taglib prefix="res" uri="http://www.springframework.org/tags/form" %> 
<!DOCTYPE html>
<html>
<head>
									...
									<div class="card-body p-md-5 text-black">
										...
										<div class="row">
											...
											<div class="col-md-8 mb-4">
												<div class="form-outline">
													...
													<textarea class="form-control" value="" id="form3Example1n1"
														path="mobile" class="form-control form-control-lg"></textarea>
										...
										<div class="row">
											...
											<div class="col-md-3 mb-4">
												<div class="form-outline">
													...
													<input type="textarea" value="" id="form3Example1n1"
														path="city" class="form-control form-control-lg" />
											...
											<div class="col-md-3 mb-4">
												<div class="form-outline">
													...
													<input type="textarea" value="" id="form3Example1n1"
														path="state" class="form-control form-control-lg" />
											...
											<div class="col-md-3 mb-4">
												<div class="form-outline">
													<input type="text" value="" id="form3Example1n1"
														path="pin" class="form-control form-control-lg" />
												</div>
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-md-3 mb-4">
												<div class="form-outline">
													<res:input type="text" value="" id="form3Example1n1"
														path="degree" class="form-control form-control-lg" />
												</div>
											</div>
											<div class="col-md-2 mb-4">
												<div class="form-outline">
											...
											<div class="col-md-3 mb-4">
												<div class="form-outline">
													<res:input type="text" value="" id="form3Example1n1"
														path="special" class="form-control form-control-lg" />
												</div>
											</div>
										</div>
										<div class="row">
											...
											<div class="col-md-3 mb-4">
												<div class="form-outline">
													<res:input type="month" value="" id="form3Example1n1"
														path="dsDate" class="form-control form-control-lg" />
												</div>
											</div>
											<div class="col-md-2 mb-4">
												<div class="form-outline">
											...
											<div class="col-md-3 mb-4">
												<div class="form-outline">
													<res:input type="month" value="" id="form3Example1n1"
														path="deDate" class="form-control form-control-lg" />
												</div>
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-md-8 mb-4">
												<div class="form-outline">
													...
													<res:input type="text" value="" id="form3Example1n1"
														path="insName" class="form-control form-control-lg" />
										...
										<div class="row">
											...
											<div class="col-md-3 mb-4">
												<div class="form-outline">
													<res:input type="text" value="" id="form3Example1n1"
														path="school" class="form-control form-control-lg" />
												</div>
											</div>
											<div class="col-md-2 mb-4">
												<div class="form-outline">
											...
											<div class="col-md-3 mb-4">
												<div class="form-outline">
													<res:input type="text" value="" id="form3Example1n1"
														path="course" class="form-control form-control-lg" />
												</div>
											</div>
										</div>
										<div class="row">
											...
											<div class="col-md-3 mb-4">
												<div class="form-outline">
													<input type="month" value="" id="form3Example1n1"
														path="sSDate" class="form-control form-control-lg" />
												</div>
											</div>
											<div class="col-md-2 mb-4">
												<div class="form-outline">
											...
											<div class="col-md-3 mb-4">
												<div class="form-outline">
													<res:input type="month" value="" id="form3Example1n1"
														path="sEDate" class="form-control form-control-lg" />
												</div>
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-md-8 mb-4">
												<div class="form-outline">
													...
													<res:input type="text" value="" id="form3Example1n1"
														path="sInsName" class="form-control form-control-lg" />
										...
										<div class="row">
											<div class="col-md-2 mb-4">
												<div class="form-outline">
													...
													<h6>
														<label class="form-label" for="form3Example1m">SSLC/Diploma</label>
													</h6>
												</div>
											</div>
											...
											<div class="col-md-3 mb-4">
												<div class="form-outline">
													<res:input type="text" value="" id="form3Example1n1"
														path="sslc" class="form-control form-control-lg" />
												</div>
											</div>
											<div class="col-md-2 mb-4">
												<div class="form-outline">
											...
											<div class="col-md-3 mb-4">
												<div class="form-outline">
													<res:input type="text" value="" id="form3Example1n1"
														path="sslcCour" class="form-control form-control-lg" />
												</div>
											</div>
										</div>
										<div class="row">
											...
											<div class="col-md-3 mb-4">
												<div class="form-outline">
													<res:input type="month" value="" id="form3Example1n1"
														path="sslcSdate" class="form-control form-control-lg" />
												</div>
											</div>
											<div class="col-md-2 mb-4">
												<div class="form-outline">
											...
											<div class="col-md-3 mb-4">
												<div class="form-outline">
													<res:input type="month" value="" id="form3Example1n1"
														path="sslcEdate" class="form-control form-control-lg" />
												</div>
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-md-8 mb-4">
												<div class="form-outline">
													...
													<res:input type="text" value="" id="form3Example1n1"
														path="sslcIns" class="form-control form-control-lg" />
										...
										<div class="row">
											...
											<div class="col-md-3 mb-4">
												<div class="form-outline">
													<res:input type="text" value="" id="form3Example1n1"
														path="job1" class="form-control form-control-lg" />
												</div>
											</div>
											<div class="col-md-2 mb-4">
												<div class="form-outline">
											...
											<div class="col-md-3 mb-4">
												<div class="form-outline">
													<res:input type="text" value="" id="form3Example1n1"
														path="job1Desig" class="form-control form-control-lg" />
												</div>
											</div>
										</div>
										<div class="row">
											...
											<div class="col-md-3 mb-4">
												<div class="form-outline">
													<res:input type="month" value="" id="form3Example1n1"
														path="job1Sdate" class="form-control form-control-lg" />
												</div>
											</div>
											<div class="col-md-2 mb-4">
												<div class="form-outline">
											...
											<div class="col-md-3 mb-4">
												<div class="form-outline">
													<res:input type="month" value="" id="form3Example1n1"
														path="job1Edate" class="form-control form-control-lg" />
												</div>
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-md-8 mb-4">
												<div class="form-outline">
													...
													<res:input type="text" value="" id="form3Example1n1"
														path="job1Com" class="form-control form-control-lg" />
										...
										<div class="row">
											...
											<div class="col-md-8 mb-4">
												<div class="form-outline">
													...
													<res:input type="text" value="" id="form3Example1n1"
														path="job1work" class="form-control form-control-lg" />
										...
										<div class="row">
											...
											<div class="col-md-3 mb-4">
												<div class="form-outline">
													<res:input type="text" value="" id="form3Example1n1"
														path="job2" class="form-control form-control-lg" />
												</div>
											</div>
											<div class="col-md-2 mb-4">
												<div class="form-outline">
											...
											<div class="col-md-3 mb-4">
												<div class="form-outline">
													<res:input type="text" value="" id="form3Example1n1"
														path="job2Desig" class="form-control form-control-lg" />
												</div>
											</div>
										</div>
										<div class="row">
											...
											<div class="col-md-3 mb-4">
												<div class="form-outline">
													<res:input type="month" value="" id="form3Example1n1"
														path="job2Sdate" class="form-control form-control-lg" />
												</div>
											</div>
											<div class="col-md-2 mb-4">
												<div class="form-outline">
											...
											<div class="col-md-3 mb-4">
												<div class="form-outline">
													<res:input type="month" value="" id="form3Example1n1"
														path="job2Edate" class="form-control form-control-lg" />
												</div>
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-md-8 mb-4">
												<div class="form-outline">
													...
													<res:input type="text" value="" id="form3Example1n1"
														path="job2Com" class="form-control form-control-lg" />
										...
										<div class="row">
											...
											<div class="col-md-8 mb-4">
												<div class="form-outline">
													...
													<res:input type="text" value="" id="form3Example1n1"
														path="job2work" class="form-control form-control-lg" />
...
<div class="row">
											...
											<div class="col-md-8 mb-4">
												<div class="form-outline">
													...
													<res:input type="text" value="" id="form3Example1n1"
														path="skill1" class="form-control form-control-lg" />
										...
										<div class="row">
											...
											<div class="col-md-8 mb-4">
												<div class="form-outline">
													...
													<res:input type="text" value="" id="form3Example1n1"
														path="skill2" class="form-control form-control-lg" />
										...
										<div class="row">
											...
											<div class="col-md-8 mb-4">
												<div class="form-outline">
													...
													<res:input type="text" value="" id="form3Example1n1"
														path="skill4" class="form-control form-control-lg" />
										...
										<div class="row">
											...
											<div class="col-md-8 mb-4">
												<div class="form-outline">
													...
													<res:input type="text" value="" id="form3Example1n1"
														path="skill3" class="form-control form-control-lg" />
